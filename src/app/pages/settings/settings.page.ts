...
//page setting
  ...
  async changeOrder(event:any){
      ...
      await this.storage.set('selectedOption',this.selectedOption);
      ...
      let sendValues = {'mainUserName':this.mainUserName,'userName':this.userName,'password':this.password,'apiKey':this.apiKey,'orderList':this.selectedOption};
  ...
  async ngOnInit() {
    ...
    this.selectedOption = await this.storage.get('selectedOption');
